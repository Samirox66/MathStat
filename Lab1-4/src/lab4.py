...
def DrawGraphics():
    ...
    for num in range(number_of_samples):
        ...
        figures.savefig('c:/Users/bsam/Documents/web/sem6/mathStat/MathStat/Lab1-4/res/lab4/' +name_list[num] + str(sizes[size]) + ".png")
    return
...
def DrawKDE():
    ...
    for num in range(number_of_samples):
        for size in range(len(sizes)):
            ...
            plt.show()
            figures.savefig('c:/Users/bsam/Documents/web/sem6/mathStat/MathStat/Lab1-4/res/lab4/' + name_list[num] + ' KDE ' + str(sizes[size]) + ".png")
    return
